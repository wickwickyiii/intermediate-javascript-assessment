...
String.prototype.grammarPolice = function(str) {
  ...
  let grammar = words.join(" ");
  return grammar;
};

// ******** I don't know if I'm understanding this question wrong but as far as I get it, I'm getting my function to return a new string with the first letter of each word capitalized and the rest lower ****************
...
function promiseCatcher(arg) {
  let handlePromise = arg;

  theAnswer = handlePromise;
  return theAnswer;
}
